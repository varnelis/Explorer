if __name__ == "__main__":
    ...
    # OPTIONAL - Can finetune from VINS dataset or WebUI dataset 
    # See https://uimodeling.github.io/ for code & data download 
    # --> download the relevant weights .ckpt files
    ...
    if os.path.exists(os.path.join(ARTIFACT_DIR, 'last-v8.ckpt')):
