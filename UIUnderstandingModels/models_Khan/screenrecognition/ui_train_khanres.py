if __name__ == "__main__":
    ...
    logger = TensorBoardLogger(ARTIFACT_DIR, version=f'version-res{min_size}-subsize{subsize}')
    ...
    checkpoint_callback2 = ModelCheckpoint(dirpath=ARTIFACT_DIR, filename=f"screenrecognition_best_res{min_size}_size{subsize}",monitor='val_mAP', mode="max", save_top_k=1)
    ...
    for seed in range(5):
        ...
        data = KhanUIDataModule(batch_size=batch_size, subset_size=subsize, rand_seed=seed)
