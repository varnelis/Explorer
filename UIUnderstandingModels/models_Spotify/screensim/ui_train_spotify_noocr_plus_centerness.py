if __name__ == "__main__":
    ...
    ARTIFACT_DIR = "checkpoints_screensim_spotify_noocr"
    ...
    from ui_models_spotify_centerness_FC import *
    ...
    data = SpotifySimilarityDataModule(batch_size=batch_size)
    ...
    ckpt_path = "screenrecognition_spotify_best_res720.ckpt"
